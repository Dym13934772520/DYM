...
public class FileServiceImpl implements FileService {
    ...
    public Result uploadSinglePhoto(HttpServletRequest request, MultipartFile file) {
        ...
        if (null == file) {
            return ResultGenerator.genFailResult(ResultCode.FILE_BULL_ERROR,"The file cannot be empty");
        }

        if (file.getSize() > 5000000){
            return ResultGenerator.genFailResult("The file is too large, please upload it again");
        }
        ...
        return ResultGenerator.genFailResult(ResultCode.FILEUPLOAD_ERROR,"File upload failure");
    }
