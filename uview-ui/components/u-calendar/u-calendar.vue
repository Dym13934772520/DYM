...
<script>
	 ...
	 * @property {String} start-text 起始日期底部的Tip文字(默认 '开始')
	 * @property {String} end-text 结束日期底部的Tip文字(默认 '结束')
	 * @property {String} btn-type 底部确定按钮的主题(默认 'primary')
	 * @property {String} toolTip 顶部Tip文字，如设置名为tooltip的slot，此参数将失效(默认 '选择日期')
