...
<script>
	/**
	 * link 超链接
	 * @description 该组件为超链接组件，在不同平台有不同表现形式：在APP平台会通过plus环境打开内置浏览器，在小程序中把链接复制到粘贴板，同时Tip信息，在H5中通过window.open打开链接。
	 ...
	 * @property {String} mp-tips 各个小程序平台把链接复制到粘贴板后的Tip语（默认“链接已复制，请在浏览器打开”）
