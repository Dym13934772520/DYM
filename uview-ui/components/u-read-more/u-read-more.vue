...
<script>
	 ...
	 * @property {String} close-text 关闭时的Tip文字（默认“展开阅读全文”）
	 * @property {String Number} font-size Tip文字的大小，单位rpx（默认28）
	 * @property {String} text-indent 段落首行缩进的字符个数（默认2em）
	 * @property {String} open-text 展开时的Tip文字（默认“收起”）
	 * @property {String} color Tip文字的颜色（默认#2979ff）
